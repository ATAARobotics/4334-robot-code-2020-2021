...
public class Crazy extends CommandBase {
   ...
   * Creates a new Shoot.
   */
  public Crazy(Shooter shooterSubsystem, Cartridge cartridgeSubsystem, FlywheelPID flywheelPID, double RPM, Intake intakeSubsystem) {
